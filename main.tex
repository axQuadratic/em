...
I denna laboration bestämdes ett uttryck för periodtiden för en sväning av en stång. Genom att mäta tiden för ett helt 
rotationvarv av flera olika stänger med olika längd, vikt och diameter. Genom att analysera tiden för ett rotationsvarv för respektive stav. Därefter plottas grafer i excel utifrån mätvärden som gör att vi kan exkludera faktorer som inte påverkar rotationstiden. 


\subsection{Experimentell uppställning}
Experimentet uppställt med en stång upphängd fritt i jämvikt från ett pianosnöre fäst i ett stativ, se figur \ref{fig:placeholder}: Längden på snöret från stativet till stången mäts samt diametern på snöret mäts med linjal och mikrometer. Stångens massa mäts med våg, längen och diametern mäts med linjal respketive skjuttmått.
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.3\linewidth]{EM-Uppsällning.jpg}
    \caption{Uppställning för mätning av rotationssvägning.}
    \label{fig:placeholder}
    
\end{figure}

\subsection{Experimentell procedur}
I detta avsnitt presenteras den mätmetod som använts under laborationens genomförande.

\subsubsection{Mätmetod}
För varje stång med känd diamter, längd och vikt bestämdes tiden för en rotationssvägning. Genom att först låta stången ligga 
vila i jämvikt och därefter vrida stången 90°, därefter med tidsur ta tiden för ett fult rotationsvarv. Rotationstiden för varje stång
fördes in i en tabell. Mätingarna för varje stav utfördes tre gånger och därefter ta medelvärdet för säkrare resultat. Rotationstiderna 
